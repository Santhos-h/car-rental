...
const Page6 = () => {
  return (
    <div>
      <section>
        <div class="left">
          <img src="https://mllafnlfvfl1.i.optimole.com/w:auto/h:auto/q:mauto/ig:avif/https://carspot.e-plugins.com/wp-content/uploads/2024/03/koke-mayayo-thevisualkiller-uG8RGApPGWk-unsplash.jpg" alt="" />
          <div class="line"></div>
          <div class="box">
            <div class="top">
              <div class="top-left">
            ...
            <div class="bottom">
              <span>Australia</span>
              <p><span>Address: </span>Clitheroe Lock, London Borough of Hounslow, London, Greater London, England, TW8 9HF, United Kingdom</p>
        ...
        <div class="right">
          ...
          <div class="city">
            <span>Australia</span>
            <span>23 March - 2024 05:19 am</span>
          </div>
