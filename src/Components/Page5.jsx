...
const Page5 = () => {
  return (
    <div>
      <section>
        <div class="left">
          <img src="https://mllafnlfvfl1.i.optimole.com/w:auto/h:auto/q:mauto/ig:avif/https://carspot.e-plugins.com/wp-content/uploads/2024/03/2b4372d347b140add0504bafa761c4fc.png" alt="" />
          <div class="line"></div>
          <div class="box">
            <div class="top">
              <div class="top-left">
            ...
            <div class="bottom">
              <span>Colorado</span>
              <p><span>Address: </span>25, Switzerland Trail, Sunset, Boulder County, Colorado, 80302, United States</p>
        ...
        <div class="right">
          ...
          <div class="city">
            <span>Coloroda</span>
            <span>23 March - 2024 10:19 am</span>
          </div>
